...
<table width="100%" class="table_list">
	<tr class="tlist_tr">
		...
		<td class="tlist_td1" width="" align="center">標題</td>
		<td class="tlist_td1" width="75" align="center">日期</td>
		<td class="tlist_td1" width="90" align="center">圖片</td>
...
?>
	<tr>
		...
		<td class="tlist_td1<?php echo $td_end;?>" align="center"><?php echo stripslashes($record['mdate']);?></td>
		<td class="tlist_td1<?php echo $td_end;?>" align="center"><?php echo ($record['mimage']!='')?'<img src="'.$sys_updata_home.$record['mimage'].'" style="max-width:76px;max-height:47px;">':'';?></td>
...
?>
	<tr>
		<td class="tlist_td1 tlist_td2 tlist_td3" colspan="6" align="center">暫無資料</td>
	</tr>
<?php
	}
?>
