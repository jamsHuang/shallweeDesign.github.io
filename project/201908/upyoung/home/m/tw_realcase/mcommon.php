...
//===========================================================================
	...
	if( isset($_GET['spaget']) && is_numeric($_GET['spaget']) )
		...
		$page_total=10;
	$page_group=5;  //一組幾頁
	$page_link='tw_realcase/list.php';  //列表頁
	$page_link_edit='tw_realcase/edit.php';  //編輯頁

	$page_title='實績案例';  //模組名稱
	$mpk='rid';  //資料表 PK
	$mtable=$tw_realcase;  //資科表名稱-對照 common.php 統一設定
	$mfname='mtitle';  //主標題欄位
	$mfile=array('mimage');
