...
(lib.unit_spring_thin = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-21.25,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.unit_spring_thin, new cjs.Rectangle(-21.2,0,42.5,227.5), null);
...
(lib.unit_spring_thick = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-39.25,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.unit_spring_thick, new cjs.Rectangle(-39.2,0,78.5,227.5), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1574220498608", id:"bg"},
		{src:"images/Bitmap1.png?1574220498608", id:"Bitmap1"},
		{src:"images/thickspring.png?1574220498608", id:"thickspring"},
		{src:"images/thinspring.png?1574220498608", id:"thinspring"},
		{src:"images/weight_1.png?1574220498608", id:"weight_1"},
		{src:"images/weight_2.png?1574220498608", id:"weight_2"},
		{src:"images/weight_3.png?1574220498608", id:"weight_3"},
		{src:"images/weight_4.png?1574220498608", id:"weight_4"},
		{src:"images/weight_green.png?1574220498608", id:"weight_green"}
	],
	preloads: []
};
