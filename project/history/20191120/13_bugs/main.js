...
(lib.hitbg = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("rgba(204,204,204,0.6)").s().p("Ao/E0IAApnIR/AAIAAJng");
...
(lib.hit_area = function(mode,startPosition,loop) {
	...
	this.mark.setTransform(30.05,3.45);
	...
	this.shape_4.graphics.f("rgba(204,204,255,0.718)").s().p("AkcEdIAAo5II5AAIAAI5g");
...
}).prototype = getMCSymbolPrototype(lib.hit_area, new cjs.Rectangle(0,-0.6,115.2,66.1), null);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var total = 0;
		//
		var area1 = [main.mc_area1.x, main.mc_area1.y, main.mc_area1.mark.getBounds().width, main.mc_area1.getBounds().height];
		var area2 = [main.mc_area2.x, main.mc_area2.y, main.mc_area2.getBounds().width, main.mc_area2.getBounds().height];
		var area3 = [main.mc_area3.x, main.mc_area3.y, main.mc_area3.getBounds().width, main.mc_area3.getBounds().height];
		var area4 = [main.mc_area4.x, main.mc_area4.y, main.mc_area4.getBounds().width, main.mc_area4.getBounds().height];
		var area5 = [main.mc_area5.x, main.mc_area5.y, main.mc_area5.getBounds().width, main.mc_area5.getBounds().height];
		var area6 = [main.mc_area6.x, main.mc_area6.y, main.mc_area6.getBounds().width, main.mc_area6.getBounds().height];
		var area7 = [main.mc_area7.x, main.mc_area7.y, main.mc_area7.getBounds().width, main.mc_area7.getBounds().height];
		var area8 = [main.mc_area8.x, main.mc_area8.y, main.mc_area8.getBounds().width, main.mc_area8.getBounds().height];
		var area9 = [main.mc_area9.x, main.mc_area9.y, main.mc_area9.getBounds().width, main.mc_area9.getBounds().height];
	...
	this.mc_area4.setTransform(33.6,298.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.mc_area4},{t:this.mc_area2},{t:this.mc_area3},{t:this.mc_area5},{t:this.mc_area6},{t:this.mc_area8},{t:this.mc_area7},{t:this.mc_area9},{t:this.mc_area10},{t:this.mc_area11},{t:this.mc_sb}]}).wait(1));
	...
	this.text_total.alpha = 0.71372549;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Asset22x100.jpg?1574213347474", id:"Asset22x100"},
		{src:"images/Asset22x8.png?1574213347474", id:"Asset22x8"},
		{src:"images/Asset32x8.png?1574213347474", id:"Asset32x8"},
		{src:"images/Asset42x8.png?1574213347474", id:"Asset42x8"},
		{src:"images/farm2x8.png?1574213347474", id:"farm2x8"}
	],
	preloads: []
};
