...
(lib.main_view = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.mc_text},{t:this.text_thin1},{t:this.text_thick1},{t:this.text_thin2},{t:this.text_thick2},{t:this.text_thin3},{t:this.text_thick3},{t:this.text_thin4},{t:this.text_thick4},{t:this.text_thin5},{t:this.text_thick5},{t:this.shape},{t:this.sp_thin},{t:this.sp_thick},{t:this.hit_1},{t:this.hit_2},{t:this.mc_weight1},{t:this.mc_weight2},{t:this.mc_weight3},{t:this.mc_weight4},{t:this.mc_weight5}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.main_view, new cjs.Rectangle(-8,0,1032,768), null);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		main.mc_weight1.on("pressmove", function (evt) {
			console.log('pressmove',evt.currentTarget);
			reset();
	...
	this.main_view.setTransform(515.95,384,1,1,0,0,0,507.9,384);

	this.timeline.addTween(cjs.Tween.get(this.main_view).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(512,384,520.0999999999999,384);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1578255684829", id:"bg"},
		{src:"images/Bitmap1.png?1578255684829", id:"Bitmap1"},
		{src:"images/thickspring.png?1578255684830", id:"thickspring"},
		{src:"images/thinspring.png?1578255684830", id:"thinspring"},
		{src:"images/weight_1.png?1578255684830", id:"weight_1"},
		{src:"images/weight_2.png?1578255684830", id:"weight_2"},
		{src:"images/weight_3.png?1578255684830", id:"weight_3"},
		{src:"images/weight_4.png?1578255684830", id:"weight_4"},
		{src:"images/weight_green.png?1578255684830", id:"weight_green"}
	],
	preloads: []
};
